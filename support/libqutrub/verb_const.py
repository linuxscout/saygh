...
SubjectNoun = u"اسم فاعل"
ObjectNoun = u"اسم مفعول"
...
IRREGULAR_VERB_CONJUG[u"رءى"+FATHA+FATHA] = {
    ...
    SubjectNoun:(u"رءي", ALEF_HARAKA+KASRA+DAMMA), 
    ObjectNoun:(u"رءي", FATHA + SUKUN + WAW_HARAKA, DAMMA), 
}
IRREGULAR_VERB_CONJUG[u"ءري"+FATHA+FATHA] = {
    ...
    SubjectNoun:(u"ءري", ALEF_HARAKA+KASRA+DAMMA), 
    ObjectNoun:(u"ءري", FATHA + SUKUN + WAW_HARAKA, DAMMA),    
    }
...
IRREGULAR_VERB_CONJUG[u"وذر"+KASRA+FATHA] = {
    ...
    SubjectNoun:(u"وذر", ALEF_HARAKA+KASRA+DAMMA), 
    ObjectNoun:(u"وذر", FATHA + SUKUN + WAW_HARAKA, DAMMA), 
}
# الفعل وَسِعَ يسع
# KASRA FATHA
IRREGULAR_VERB_CONJUG[u"وسع"+KASRA+FATHA] = {
    ...
    SubjectNoun:(u"وسع", ALEF_HARAKA+KASRA+DAMMA), 
    ObjectNoun:(u"وسع", SUKUN + WAW_HARAKA, DAMMA), 
}
# الفعل وطئ يطأ
# KASRA FATHA
IRREGULAR_VERB_CONJUG[u"وطء"+KASRA+FATHA] = {
    ...
    SubjectNoun:(u"وطء", ALEF_HARAKA+KASRA+DAMMA), 
    ObjectNoun:(u"وطء", FATHA + SUKUN + WAW_HARAKA, DAMMA), 
}
...
IRREGULAR_VERB_CONJUG[u"ءكل"+FATHA+DAMMA] = {
    ...
    SubjectNoun:(u"ءكل", ALEF_HARAKA+KASRA+DAMMA), 
    ObjectNoun:(u"ءكل", FATHA + SUKUN + WAW_HARAKA, DAMMA),     
}
...
IRREGULAR_VERB_CONJUG[u"ءخذ"+FATHA+DAMMA] = {
    ...
    SubjectNoun:(u"ءخذ", ALEF_HARAKA+KASRA+DAMMA), 
    ObjectNoun:(u"ءخذ", FATHA + SUKUN + WAW_HARAKA, DAMMA),     
}
...
IRREGULAR_VERB_CONJUG[u"وبء"+FATHA+FATHA] = {
    ...
    SubjectNoun:(u"وبء", ALEF_HARAKA+KASRA+DAMMA), 
    ObjectNoun:(u"وبء", FATHA + SUKUN + WAW_HARAKA, DAMMA),     
}
# الفعل وبه يوبه
#FATHA FATHA
IRREGULAR_VERB_CONJUG[u"وبه"+FATHA+FATHA] = {
    ...
    SubjectNoun:(u"وجع", ALEF_HARAKA+KASRA+DAMMA), 
    ObjectNoun:(u"وجع", FATHA + SUKUN + WAW_HARAKA, DAMMA),     
}
# الفعل وجع يوجع
#FATHA FATHA
...
IRREGULAR_VERB_CONJUG[u"وسع"+FATHA+FATHA] = {
    ...
    TenseImperative:    (u"وسع", SUKUN+FATHA+SUKUN), 
        SubjectNoun:(u"وسع", ALEF_HARAKA+KASRA+DAMMA), 
    ObjectNoun:(u"وسع", FATHA + SUKUN + WAW_HARAKA, DAMMA), 
}
...
IRREGULAR_VERB_CONJUG[u"وهل"+FATHA+FATHA] = {
    ...
    SubjectNoun:(u"وهل", ALEF_HARAKA+KASRA+DAMMA), 
    ObjectNoun:(u"وهل", FATHA + SUKUN + WAW_HARAKA, DAMMA), 
}
